...
$query = mysqli_query($connect, "select B.kode_barang, B.nama_barang, B.harga_net, B.stok, M.no_nota, M.kode_barang, M.jumlah, M.subtotal from tblbarang B inner join tbldetailbrgmasuk M on B.kode_barang=M.kode_barang where no_nota='$no_nota'");
